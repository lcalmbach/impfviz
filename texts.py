...
In der vorliegenden App kann aus drei Szenarien ausgewählt werden: Impfschutz für 1 Jahr bzw. 6 oder 8 Monate. Bei den Infektionen wird angenommen, dass Personen ohne Impfschutz oder auf Personen, deren Imfpschutz abegelaufen vier Mal anfälliger auf eine Infektion sind als Geimpfte. Auch hier wären unterschiedliche Szenarien sinnvoll. Wichtig bei der Interpretation dieser Resultate ist das Bewusstsein, dass es sich um ein Modell handelt und dass man dessen Annahmen kennt.
